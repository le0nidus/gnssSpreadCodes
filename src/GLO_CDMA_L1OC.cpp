...
void GLO_CDMA_L1::l1ocd(int prn) {
	...
	generatePRN(g1, g2, GLO_CDMA_L1OCd_LENGTH, GLO_CDMA_L1OCd_TAPS_G1, GLO_CDMA_L1OCd_TAPS_G2);
	return;
}
...
void GLO_CDMA_L1::l1ocp(int prn) {
	...
	generatePRN(g1, g2, GLO_CDMA_L1OCp_LENGTH, GLO_CDMA_L1OCp_TAPS_G1, GLO_CDMA_L1OCp_TAPS_G2);
	return;
}
